...
//title //description //button1 //button2 //button3 //inventoryItem
    ...
    function level2(){
        ...
        document.getElementById("inventoryItem").src = "Assets/RuimteVh/deur.jpg";
        ...
        var itemlvl1 = item;
        itemlvl1.src = "Assets/RuimteVh/SwipeCard.jpg";
   ...
   //Function voor level 3.
    ...
    function wapen(){
        ...
        button1.innerText = "Druk op om de alien te doden.";
        button2.style.display = "none";
        button3.style.display = "none";
